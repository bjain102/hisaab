...
// HSBC is PDF-only: no CSV export format has been seen for it, so the CSV
// upload path deliberately has no hsbc entry and returns a clean 400.
const PDF_CAPABLE = new Set(['idfc', 'icici', 'axis', 'kotak', 'hdfc', 'amex', 'hsbc', 'indusind'])
