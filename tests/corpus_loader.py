...
FILENAME_BANKS = [
    ...
    ('HDFC', 'hdfc'),
    ('HSBC', 'hsbc'),
    # Filename says CRED (the co-brand); the parser key is the issuer.
    ('CRED_INDUSIND', 'indusind'),
    ('IDFC', 'idfc'),
    ('KOTAK', 'kotak'),
]
...
def tier1_entries():
    """[{path, bank, format}] — every committed sanitized file. No skipping:
    an unmappable tier1 file is a mistake and raises."""
    entries = []
